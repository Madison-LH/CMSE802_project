...
X_train, X_temp, y_train, y_temp = train_test_split(
    image_paths, y, test_size=0.3, stratify=y, random_state=42)
...
def preprocess(img_path, label):
    # img is tf.string -> becomes tf.uint8 after decode_jpeg
...
# SavedModel or Keras HDF5 format
model.save("mobilenet_behavior_classifier.keras")
